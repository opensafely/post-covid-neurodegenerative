...
################################
    ...
    # Primary
    tmp_cov_date_hypercholesterolaemia_snomed=patients.with_these_clinical_events(
    ...
    # HES
    tmp_cov_date_hypercholesterolaemia_hes=patients.admitted_to_hospital(
        returning="date_admitted",
    ...
    cov_bin_hypercholesterolaemia=patients.minimum_of(
        "tmp_cov_date_hypercholesterolaemia_snomed", "tmp_cov_date_hypercholesterolaemia_hes",#tmp_out_date_hypercholesterolaemia_death
    ),
