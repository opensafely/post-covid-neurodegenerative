...
for (cohort in c("prevax","vax","unvax")) {
  ...
  table2$total_events_midpoint6_redacted <- table2$exposed_events_midpoint6 + table2$unexposed_events_midpoint6
  ...
  table2 <- table2[,c("name","cohort","exposure","outcome","analysis",
                      ...
                      "total_person_days","total_events_midpoint6_redacted","day0_events_midpoint6",
