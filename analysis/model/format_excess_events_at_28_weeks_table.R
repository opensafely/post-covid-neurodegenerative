...
#Read in AER
df <- readr::read_csv("C:/Users/rs22981/Opensafely/Neurodegenerative/21_07_2023/AER_compiled_results.csv") #Change according to repo/OneDrive and date 
...
write.csv(df, "C:/Users/rs22981/Opensafely/Neurodegenerative/21_07_2023/Estimated excess events at 28 weeks.csv", row.names = F) #Change according to repo/OneDrive and date
