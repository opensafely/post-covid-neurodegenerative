...
path_model_output <- paste0(release,"model_output_rounded.csv")
path_table1 <- paste0(release,"table1_output_rounded.csv")
path_table2 <- paste0(release,"table2_output_rounded.csv")
path_venn <- paste0(release,"venn_output_rounded.csv")
# path_extendedtable1 <- paste0(release,"extendedtable1_output_rounded.csv")