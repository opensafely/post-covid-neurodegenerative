...
output_dir <- paste0(
  release,
  "20260129_noday0/" # 20251125_noday0
)

files_to_exclude <- c()
files_to_add <- c(
  "../20251103/model_output-sub_cis_noday0-midpoint6.csv",
  "../20251125/model_output-sub_age_noday0-midpoint6.csv",
  "../20251125/model_output-sub_covidhistory_noday0-midpoint6.csv",
  "../20251125/model_output-sub_covidhospital_noday0-midpoint6.csv",
  "../20251125/model_output-sub_ethnicity_noday0-midpoint6.csv",
  "../20251125/model_output-sub_highvascrisk_noday0-midpoint6.csv",
  "../20251125/model_output-sub_park_noday0-midpoint6.csv",
  "../20251125/model_output-sub_parkrisk_noday0-midpoint6.csv",
  "../20251125/model_output-sub_sex_noday0-midpoint6.csv"
) #was fully converged in a previous output so didn't need to be rerun
