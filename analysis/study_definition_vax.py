...
(
    dynamic_variables
) = generate_common_variables(index_date_variable="index_date_vax", exposure_end_date_variable="end_date_vax", outcome_end_date_variable="end_date_vax_outcome")
...
study = StudyDefinition(
    ...
    end_date_vax_outcome = patients.with_value_from_file(
        f_path = 'output/index_dates.csv.gz', 
        returning = 'end_vax', 
        returning_type = 'date', 
        date_format = 'YYYY-MM-DD',     
