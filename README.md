...
-   Detailed protocols are in the [`protocol`](./protocol/) folder.
    ...
    - [`post-covid-events-neurodegenerative`](protocol/post-covid-events-neurodegenerative.pdf) contains the outcome-specific elements necessary to implement [`post-covid-events-ehrql`](protocol/post-covid-events-ehrql.pdf) contains the core protocol.
