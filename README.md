...
-   Analyses scripts are in the [`analysis`](./analysis) directory:
    ...
    -   Venn scripts are in the [`venn`](./analysis/venn/) directory:
        -   This directory contains a single script:  [`venn.R`](.venn/venn/venn.R). This script works with the output of [`dataset_clean`](./analysis/dataset_clean/) to create venn diagram data for all outcomes reporting where outcomes are sourced from i.e primary care, secondary care or deaths data
